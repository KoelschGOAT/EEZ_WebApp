...
const Bar = ({}: Props) => {
  ...
  return (
    <div className=" flex flex-col w-14 hover:w-60 2xl:w-60 bg-white shadow-xl h-screen transition-all duration-300 border-none z-10 sidebar">
      <div className="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
        <ul className="flex flex-col py-4 space-y-2 gap-2">
          <li className="px-5 hidden 2xl:block mb-5">
            <div className="flex flex-row items-center h-8">
              <div className="text-lg font-light tracking-wide text-gray-400 uppercase">
                <LanguageDisplayer de="Admin Menü" en="Admin Area" />
              </div>
            </div>
          </li>
